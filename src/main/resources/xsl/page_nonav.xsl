...
<xsl:stylesheet exclude-result-prefixes="#all" version="2.0"
	...
	<xsl:template match="content" priority="-2.5" mode="html-body">
		...
		<body>
			<div id="container" style="width: 800px; margin-left: auto; margin-right: auto; background-image:none;"> 
                <div id="lock" /> 
                <div id="content" style="position: relative">
				
					<div id="logo" style="margin: 0; padding: 0; width: 220px; margin-left: auto; margin-right: auto; margin-top: -20px; margin-bottom: -20px; z-index: 1">
						<a href="{$base-url}">
